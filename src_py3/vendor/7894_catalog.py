...
class Homespice_Decor():
	...
	def __init__(self,vendor,mode=2):
		...
		for x in range(1,rsheet.nrows):
			...
			if "y" in rsheet.row(x)[28].value.lower(): #skip closeouts
				continue
