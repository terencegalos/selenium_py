...
class Coast_Lamp_Mfg():
    ...
    def __init__(self,vendor,mode=2):
        ...
        for x in range(2,rsheet.nrows):
            ...
            self.prod[sku]['top'] = ""
            self.prod[sku]['min'] = 1
            self.prod[sku]['price1'] = rsheet.row(x)[17].value
            self.prod[sku]['min2'] = ""
            self.prod[sku]['price2'] = ""
            self.prod[sku]['min3'] = ""
            self.prod[sku]['price3'] = ""
            self.prod[sku]['multi'] = 1
            self.prod[sku]['img400'] = "Coast400"
            self.prod[sku]['img160'] = "Coast160"
            self.prod[sku]['jpg400'] = rsheet.row(x)[40].value
            self.prod[sku]['jpg160'] = ""
            self.prod[sku]['desc2'] = rsheet.row(x)[1].value
            self.prod[sku]['opt'] = ""
            self.prod[sku]['img800'] = "Coast800"
