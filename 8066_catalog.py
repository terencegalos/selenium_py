...
class Timeless_By_Design_Closeouts():
	prod = {}
	skus = None
	disc = False
	...
	def __init__(self,vendor,mode=2):
		...
		for x in range(1,rsheet.nrows):
			...
			self.prod[sku]['sale'] = rsheet.row(x)[8].value
			self.prod[sku]['set'] = ""
			...
			self.prod[sku]['multi'] = ""
			self.prod[sku]['img400'] = "Timeless400"
			self.prod[sku]['img160'] = "Timeless160"
			self.prod[sku]['jpg400'] = ""
			self.prod[sku]['jpg160'] = ""
			self.prod[sku]['desc2'] = ""
			self.prod[sku]['opt'] = ""
			self.prod[sku]['img800'] = "Timeless800"
