...
class deltonsale(domainobject.domainobject):

    vendor = "Delton Products Closeouts"
    ...
    def get_info(self,item=None):
        ...
        db.desc = self.driver.find_element_by_css_selector("#main-content > div.container > form > div > div.detail-pop-product-info.col-md-4.col-sm-10 > div > table > tbody > tr:nth-child(5) > td > p > span").text.encode("utf-8")
        db.stock = ""
