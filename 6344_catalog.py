...
class Pine_Valley_Pictures():
	...
	def __init__(self,vendor,mode=2):
		...
		for x in range(rsheet.nrows):
			...
			self.prod[sku] = {}
			self.prod[sku]['name'] = rsheet.row(x)[1].value + " " + rsheet.row(x)[4].value
			...
			self.prod[sku]['top'] = ""
			self.prod[sku]['min'] = 1
			self.prod[sku]['price1'] = float(rsheet.row(x)[3].value/2)
			self.prod[sku]['min2'] =""
			self.prod[sku]['price2'] = ""
			self.prod[sku]['min3'] = ""
			self.prod[sku]['price3'] = ""
			self.prod[sku]['multi'] = "1"
			self.prod[sku]['img400'] = "Pine400"
			self.prod[sku]['img160'] = "Pine160"
			self.prod[sku]['jpg400'] = ""
			self.prod[sku]['jpg160'] = ""
			self.prod[sku]['desc2'] = ""
			self.prod[sku]['opt'] = ""
			self.prod[sku]['img800'] = "Pine800"
