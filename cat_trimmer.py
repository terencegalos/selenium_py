...
with open(os.path.dirname(__file__)+"/csv/infile/upload file/"+vendor+".csv","rb") as file:
...
with open(os.path.dirname(__file__)+"/csv/infile/upload file/"+vendor+".csv","wb") as file:
