...
br.get(targetv.sitemap)
total = int(br.find_element_by_xpath('//*[@id="product-listing-container"]/span').text.split()[0])
print(total)
myCounter = Counter()
...
myCounter.subtotal += 1
print "Progress:",(myCounter.subtotal/total) * 100,"%"

items = targetv.search_item() #search item
targetv.export_all_product_urls(items)
